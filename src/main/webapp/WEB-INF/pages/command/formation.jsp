...
<button onclick="openMenu('formation?formation=${formation.id}')"><img src="assets/setFormation.png" /></button>
...
<c:if test="${!formation.deployed || player.id != formation.player.id || formation.lastCity.player.id != player.id }">
    <button onclick="openMenu('formation?formation=${formation.id}')"><img src="assets/infoFormation.png" /></button>
</c:if>
<br><br>
