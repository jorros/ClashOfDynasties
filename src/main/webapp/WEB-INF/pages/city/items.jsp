    ...
    <div style="float:left;">
        <div class="section" style="width:285px; margin-bottom:20px;">
            ...
            <div>
                ...
                <c:if test="${city.requiredItemTypes.contains(items[0].type)}"><a style="font-weight:bold; cursor:pointer;">Verzehr stoppen?</a></c:if><c:if test="${!city.requiredItemTypes.contains(items[0].type)}"><span style="font-weight:bold;">Exportgut</span></c:if>
                <br><br><br>
                ...
                <c:if test="${city.requiredItemTypes.contains(items[1].type)}"><a style="font-weight:bold; cursor:pointer;">Verzehr stoppen?</a></c:if><c:if test="${!city.requiredItemTypes.contains(items[1].type)}"><span style="font-weight:bold;">Exportgut</span></c:if>
            </div>
        </div>
        <div class="section" style="width:285px; margin-bottom:20px;">
            ...
            <div>
                ...
                <c:if test="${city.requiredItemTypes.contains(items[2].type)}"><a style="font-weight:bold; cursor:pointer;">Verzehr stoppen?</a></c:if><c:if test="${!city.requiredItemTypes.contains(items[2].type)}"><span style="font-weight:bold;">Exportgut</span></c:if>
                <br><br><br>
                ...
                <c:if test="${city.requiredItemTypes.contains(items[3].type)}"><a style="font-weight:bold; cursor:pointer;">Verzehr stoppen?</a></c:if><c:if test="${!city.requiredItemTypes.contains(items[3].type)}"><span style="font-weight:bold;">Exportgut</span></c:if>
            </div>
        </div>
    </div>
    <div style="float:left;">
        <div class="section" style="width:285px; margin-bottom:20px;">
            ...
            <div>
                ...
                <c:if test="${city.requiredItemTypes.contains(items[6].type)}"><a style="font-weight:bold; cursor:pointer;">Verzehr stoppen?</a></c:if><c:if test="${!city.requiredItemTypes.contains(items[6].type)}"><span style="font-weight:bold;">Exportgut</span></c:if>
                <br><br><br>
                ...
                <c:if test="${city.requiredItemTypes.contains(items[8].type)}"><a style="font-weight:bold; cursor:pointer;">Verzehr stoppen?</a></c:if><c:if test="${!city.requiredItemTypes.contains(items[8].type)}"><span style="font-weight:bold;">Exportgut</span></c:if>
                <br><br><br>
                ...
                <c:if test="${city.requiredItemTypes.contains(items[10].type)}"><a style="font-weight:bold; cursor:pointer;">Verzehr stoppen?</a></c:if><c:if test="${!city.requiredItemTypes.contains(items[10].type)}"><span style="font-weight:bold;">Exportgut</span></c:if>
                <br><br><br>
                ...
                <c:if test="${city.requiredItemTypes.contains(items[11].type)}"><a style="font-weight:bold; cursor:pointer;">Verzehr stoppen?</a></c:if><c:if test="${!city.requiredItemTypes.contains(items[11].type)}"><span style="font-weight:bold;">Exportgut</span></c:if>
            </div>
        </div>
    </div>
    <div style="float:left;">
        <div class="section" style="width:285px; margin-bottom:20px;">
            ...
            <div>
                ...
                <c:if test="${city.requiredItemTypes.contains(items[4].type)}"><a style="font-weight:bold; cursor:pointer;">Verzehr stoppen?</a></c:if><c:if test="${!city.requiredItemTypes.contains(items[4].type)}"><span style="font-weight:bold;">Exportgut</span></c:if>
                <br><br><br>
                ...
                <c:if test="${city.requiredItemTypes.contains(items[5].type)}"><a style="font-weight:bold; cursor:pointer;">Verzehr stoppen?</a></c:if><c:if test="${!city.requiredItemTypes.contains(items[5].type)}"><span style="font-weight:bold;">Exportgut</span></c:if>
                <br><br><br>
                ...
                <c:if test="${city.requiredItemTypes.contains(items[7].type)}"><a style="font-weight:bold; cursor:pointer;">Verzehr stoppen?</a></c:if><c:if test="${!city.requiredItemTypes.contains(items[7].type)}"><span style="font-weight:bold;">Exportgut</span></c:if>
                <br><br><br>
                ...
                <c:if test="${city.requiredItemTypes.contains(items[9].type)}"><a style="font-weight:bold; cursor:pointer;">Verzehr stoppen?</a></c:if><c:if test="${!city.requiredItemTypes.contains(items[9].type)}"><span style="font-weight:bold;">Exportgut</span></c:if>
            </div>
        </div>
    </div>
</div>